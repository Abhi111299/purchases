...
class AdminConsumableController extends Controller
{
    ...
    public function get_consumables(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Consumabl::orderby('id', 'desc')->get();
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (in_array('9', Request()->modules)) {
                        $btn .= '<a href="/admin/edit_consumable/' . $row->id . '" class="btn btn-primary rounded-circle btn-sm" title="Edit"><i class="fa fa-edit"></i></a> ';
                    }
