             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('staff/cleaning_logs/'.Request()->segment(3)) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="cleaning_log_form" action="{{ url('staff/add_cleaning_log/'.Request()->segment(3)) }}" method="post">
                    @csrf
                     <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                           <label>Driver</label>
                           <input type="text" class="form-control" name="cleaning_log_driver" value="{{ Auth::guard('staff')->user()->staff_fname.' '.Auth::guard('staff')->user()->staff_lname }}" placeholder="Enter Driver" autocomplete="off">
