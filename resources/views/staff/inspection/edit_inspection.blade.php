             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('staff/inspections/'.$inspection->inspection_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab1">
                     <div class="panel-body">
                        <form id="inspection_form" action="{{ url('staff/edit_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                  ...
                  <div class="tab-pane fade" id="tab2">
                     <div class="panel-body">
                        <form id="exterior_inspection_form" action="{{ url('staff/add_exterior_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" name="vehicle_id" value="{{ $inspection->inspection_vehicle }}">
                           <div class="row">
                              <div class="col-md-12">
                  ...
                  <div class="tab-pane fade" id="tab3">
                     <div class="panel-body">
                        <form id="interior_inspection_form" action="{{ url('staff/add_interior_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" name="vehicle_id" value="{{ $inspection->inspection_vehicle }}">
                           <div class="row">
                              <div class="col-md-12">
                  ...
                  <div class="tab-pane fade" id="tab4">
                     <div class="panel-body">
                        <form id="hood_inspection_form" action="{{ url('staff/add_hood_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" name="vehicle_id" value="{{ $inspection->inspection_vehicle }}">
                           <div class="row">
                              <div class="col-md-12">
                  ...
                  <div class="tab-pane fade" id="tab5">
                     <div class="panel-body">
                        <form id="uvehicle_inspection_form" action="{{ url('staff/add_uvehicle_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" name="vehicle_id" value="{{ $inspection->inspection_vehicle }}">
                           <div class="row">
                              <div class="col-md-12">
                  ...
                  <div class="tab-pane fade" id="tab6">
                     <div class="panel-body">
                        <form id="test_inspection_form" action="{{ url('staff/add_test_inspection/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" name="vehicle_id" value="{{ $inspection->inspection_vehicle }}">
                           <div class="row">
                              <div class="col-md-12">
