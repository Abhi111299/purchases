...
@section("contents")
  <section class="content">
    <div class="d-flex justify-content-between align-items-center pb-4">
      <h4 class="text-white">Purchase Request List </h4>
      <div>
        <a href="{{ url("staff/add_purchase_request") }}" id="excel_download" class="btn btn-white"><i
...
@section("custom_script")
  <script>
    var dataTable = $('#purchase_request_table').DataTable({
      ...
      'ajax': {
        type: 'POST',
        url: "{{ url("staff/get_purchase_requests") }}",
        'data': function(data) {
