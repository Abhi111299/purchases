                     ...
                     <div class="panel-body">
                        <div class="col-md-12">
                           <div class="form-group">
                              <a href="{{ url('staff/add_fuel_log/'.Request()->segment(3)) }}" class="btn btn-exp btn-sm"><i class="fa fa-plus"></i> Add Fuel Log</a>
                           </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="table-responsive">
                           <table id="fuel_log_table" class="table table-bordered table-striped table-hover" style="width: 100%">
                              <thead>
                                 <tr class="info">
                                    <th>#</th>
                                    <th>Date</th>
