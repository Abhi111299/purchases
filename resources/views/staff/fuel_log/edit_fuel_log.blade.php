             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('staff/fuel_logs/'.$fuel_log->fuel_log_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="fuel_log_form" action="{{ url('staff/edit_fuel_log/'.Request()->segment(3)) }}" method="post">
                    @csrf
