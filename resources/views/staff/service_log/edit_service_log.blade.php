             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('staff/service_logs/'.$service_log->service_log_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="service_log_form" action="{{ url('staff/edit_service_log/'.Request()->segment(3)) }}" method="post">
                    @csrf
