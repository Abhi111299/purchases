...
<table class="items-table">
    ...
    <tbody>
        @foreach ($items as $index => $consumable)
        <tr>
            <td>{{ $index + 1 }}</td>
...
<div class="terms">
    ...
    <p>2. Price and Payment: The price specified in the purchase order is firm and not subject to escalation. Payment terms are as specified in the purchase order. Payment will be made within 30 days from receipt of the invoice and satisfactory delivery of goods/services unless otherwise stated.</p>
