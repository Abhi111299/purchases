...
@section("contents")
  <section class="content">
    <div class="d-flex justify-content-between align-items-center pb-4">
      <h4 class="text-white">Job Card No - <b>{{ $booking->booking_job_id }}</h4>
      <div>
        <div class="form-group">
          <a href="{{ url("admin/download_booking/" . Request()->segment(3)) }}" class="btn btn-white"><i
        ...
        <div class="card panel-bd">
          <div class="card-body">
            <ul class="nav nav-tabs">
              <li class="nav-item active" class="nav-link">
              ...
              <li class="nav-item">
                <button class="nav-link" id="working-hour-tab" data-bs-toggle="tab" data-bs-target="#working-hour"
                  type="button" role="tab" aria-controls="working-hour" aria-selected="false">Working Hours</button>
                {{-- <a class="nav-link" href="#tab4" data-toggle="tab">Working Hours</a> --}}
              </li>
              <li class="nav-item">
                <button class="nav-link" id="voucher-tab" data-bs-toggle="tab" data-bs-target="#voucher" type="button"
                  role="tab" aria-controls="voucher" aria-selected="false">Voucher</button>
                {{-- <a class="nav-link" href="#tab3" data-toggle="tab">Voucher</a> --}}
              </li>
              <li class="nav-item">
                <button class="nav-link" id="photograph-tab" data-bs-toggle="tab" data-bs-target="#photograph"
                  type="button" role="tab" aria-controls="photograph" aria-selected="false">Photographs</button>
                {{-- <a class="nav-link" href="#tab5" data-toggle="tab">Photographs</a> --}}
              </li>
              <li class="nav-item">
                <button class="nav-link" id="upload-tab" data-bs-toggle="tab" data-bs-target="#upload" type="button"
                  role="tab" aria-controls="upload" aria-selected="false">Uploads</button>
                {{-- <a class="nav-link" href="#tab2" data-toggle="tab">Upload</a> --}}
              </li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="general" role="tabpanel" aria-labelledby="general-tab" tabindex="0">
                <div class="card-body">
                  <form action="{{ url("admin/update_booking_status/" . Request()->segment(3)) }}" method="post">
                    @csrf
                    <div class="row">
              ...
              <div class="tab-pane fade" id="upload" role="tabpanel" aria-labelledby="upload-tab" tabindex="0">
                <div class="card-body">
                  <form action="{{ url("admin/upload_booking_files/" . Request()->segment(3)) }}" method="post"
              ...
              <div class="tab-pane fade" id="voucher" role="tabpanel" aria-labelledby="voucher-tab" tabindex="0">
                <div class="card-body">
                  <form id="voucher_form" action="{{ url("admin/update_voucher/" . Request()->segment(3)) }}"
                    method="post">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div id="vsig"></div>
                          <br />
                          <button id="clear" class="btn btn-danger btn-sm my-3">Clear Signature</button>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div id="csig"></div>
                          <br />
                          <button id="cclear" class="btn btn-danger btn-sm my-3">Clear Signature</button>
              ...
              <div class="tab-pane fade" id="working-hour" role="tabpanel" aria-labelledby="working-hour-tab"
                tabindex="0">
                <div class="card-body">
                  <div class="col-md-12 ">
                    <div class="form-group mb-3 d-flex-justify-content-end">
                      <a href="javascript:void(0)" class="btn btn-exp btn-primary" data-bs-toggle="modal"
                        data-bs-target="#addWorkingModal"><i class="fa fa-plus"></i> Add Working Hour</a>
                    </div>
                  </div>
                  <div class="table-responsive">
                    <table id="working_hour_table" class="table w-100">
                      <thead>
                        <tr class="info">
                          <th>#</th>
                          <th>Date</th>
                      ...
                      <tbody>
                        @foreach ($working_hours as $working_hour)
                          <tr>
                            ...
                            <td><a href="javascript:void(0)" class="btn btn-primary rounded-circle btn-sm"
                                onclick="edit_working_hour({{ $working_hour->wh_id }})"><i class="fa fa-edit"></i></a>
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
              ...
              <div class="tab-pane fade" id="photograph" role="tabpanel" aria-labelledby="photograph-tab"
                tabindex="0">
                <div class="card-body">
                  <form action="{{ url("admin/upload_photographs/" . Request()->segment(3)) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-6 mb-3">
  ...
  <div class="modal fade" id="addWorkingModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form id="working_hour_form" action="{{ url("admin/add_working_hour/" . Request()->segment(3)) }}"
          method="post">
          @csrf
  ...
  <div class="modal fade" id="editWorkingModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Edit Working Hour</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="edit_working_hour_form" action="{{ url("admin/edit_working_hour/" . Request()->segment(3)) }}"
          method="post">
        </form>
      </div>
    </div>
...
@section("custom_script")
  ...
  <script>
    ...
    function edit_working_hour(working_id) {
      var csrf = "{{ csrf_token() }}";

      $.ajax({
        url: "{{ url("admin/get_working_hour_details") }}",
        type: "post",
        data: "working_id=" + working_id + '&_token=' + csrf,
        success: function(data) {

          $('#editWorkingModal').modal('show');
          $("#edit_working_hour_form").html(data);
        }
      });
    }
