...
@section("contents")
  <section class="content-header">
    <div class="header-title">
      <h1 class="text-white">Timesheets</h1>
    </div>
  </section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card panel-bd">
          ...
          <div class="card-body">
            <form id="timesheet_form" action="{{ url("admin/edit_timesheet/" . Request()->segment(3)) }}" method="post">
              @csrf
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                      value="{{ $timesheet->staff_fname . " " . $timesheet->staff_lname }}" readonly>
                    <input type="hidden" class="form-control" name="timesheet_staff"
                      value="{{ $timesheet->timesheet_staff }}">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="timesheet_date" id="timesheet_date"
                      value="{{ date("d-m-Y", strtotime($timesheet->timesheet_date)) }}" placeholder="Select Date"
                      autocomplete="off">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control selectbox" id="timesheet_wtype" name="timesheet_wtype">
                      ...
                      <option value="3" {{ $timesheet->timesheet_wtype == 3 ? "selected" : "" }}>Annual Leave
                      </option>
                      ...
                      <option value="6" {{ $timesheet->timesheet_wtype == 6 ? "selected" : "" }}>Saturday Holiday
                      </option>
                      <option value="7" {{ $timesheet->timesheet_wtype == 7 ? "selected" : "" }}>Sunday Holiday
                      </option>
                      <option value="8" {{ $timesheet->timesheet_wtype == 8 ? "selected" : "" }}>Public Holiday
                      </option>
                      <option value="9" {{ $timesheet->timesheet_wtype == 9 ? "selected" : "" }}>Others</option>
                    </select>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="timesheet_start" id="timesheet_start"
                      @if (!empty($timesheet->timesheet_start)) value="{{ date("h:i A", strtotime($timesheet->timesheet_start)) }}" @endif
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="timesheet_end" id="timesheet_end"
                      @if (!empty($timesheet->timesheet_end)) value="{{ date("h:i A", strtotime($timesheet->timesheet_end)) }}" @endif
                    ...
                    <select class="form-control selectbox" id="timesheet_client" name="timesheet_client">
                      ...
                      @foreach ($customers as $customer)
                        <option value="{{ $customer->customer_id }}"
                          {{ $timesheet->timesheet_client == $customer->customer_id ? "selected" : "" }}>
                    ...
                    <select class="form-control selectbox" id="timesheet_location" name="timesheet_location">
                      ...
                      @foreach ($locations as $location)
                        <option value="{{ $location->location_id }}"
                          {{ $timesheet->timesheet_location == $location->location_id ? "selected" : "" }}>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="timesheet_desc" name="timesheet_desc" placeholder="Enter Description"
                      autocomplete="off">{{ $timesheet->timesheet_desc }}</textarea>
