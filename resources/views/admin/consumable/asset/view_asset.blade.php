...
<div class="row">
    <div class="col-sm-12 col-md-4">
        <div class="card">
            ...
            <div class="card-header" style="background-image: url('{{ asset(config('constants.admin_path').'uploads/asset/'.$asset->asset_image) }}');height:200px">
            @else
            <div class="card-header" style="background-image: url({{ asset(config('constants.admin_path').'dist/img/no_image.jpeg') }});height:200px">
            @endif
            ...
            <div class="card-content-member text-center">
                ...
                <p class="m-t-0"><i class="fa fa-edit"></i> <a href="{{ url('admin/edit_asset/'.Request()->segment(3)) }}">Edit</a></p>
                @endif
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="review-block-description">
                        ...
                        <a href="{{ asset(config('constants.admin_path').'uploads/asset/'.$asset->asset_packing_file) }}" target="_blank">Click Here</a> to View Document
                        @else
                        -
                        @endif
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="review-block-description">
                        ...
                        <a href="{{ asset(config('constants.admin_path').'uploads/asset/'.$asset->asset_manufacture_file) }}" target="_blank">Click Here</a> to View Document
                        @else
                        -
                        @endif
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="review-block-description">
                        ...
                        <a href="{{ asset(config('constants.admin_path').'uploads/asset/'.$asset->asset_manual_file) }}" target="_blank">Click Here</a> to View Document
                        @else
                        -
                        @endif
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="review-block-description">
                        ...
                        <a href="{{ asset(config('constants.admin_path').'uploads/asset/'.$asset->asset_supporting_file) }}" target="_blank">Click Here</a> to View Document
                        @else
                        -
                        @endif
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="review-block-description">
                        ...
                        <div>
                            <a href="{{ asset(config('constants.admin_path').'uploads/asset/'.$photographs_file) }}" target="_blank">Click Here</a> to View Document
                        </div>
                        @endforeach
                        @else
                        -
