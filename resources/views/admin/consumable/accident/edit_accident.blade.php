             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('admin/accidents/'.$accident->accident_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="accident_form" action="{{ url('admin/edit_accident/'.Request()->segment(3)) }}" method="post" enctype="multipart/form-data">
                    @csrf
