...
@section("title", config("constants.site_title") . " | Edit Job")
@section("contents")
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card panel-bd">
          <div class="card-body">
            <form id="edit_booking_form" action="{{ url("admin/edit_booking/" . Request()->segment(3)) }}" method="post"
              ...
              <div class="row">
                    ...
                    <select class="form-control selectbox" name="booking_service">
                      ...
                      @foreach ($services as $service)
                        <option value="{{ $service->service_id }}"
                          {{ $booking->booking_service == $service->service_id ? "selected" : "" }}>
                    ...
                    <select class="form-control selectbox" id="booking_customer" name="booking_customer"
                      ...
                      @foreach ($customers as $customer)
                        <option value="{{ $customer->customer_id }}"
                          {{ $booking->booking_customer == $customer->customer_id ? "selected" : "" }}>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_start" name="booking_start"
                      value="{{ date("d-m-Y H:i", strtotime($booking->booking_start)) }}" placeholder="Select Start Date"
                      autocomplete="off">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_end" name="booking_end"
                      value="{{ date("d-m-Y H:i", strtotime($booking->booking_end)) }}" placeholder="Select End Date"
                      autocomplete="off">
                ...
                @php
                  $activities_arr = json_decode($booking->booking_activities, true);
                @endphp
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <select class="form-control selectbox" name="booking_activities[]" multiple>
                      ...
                      @foreach ($activities as $activity)
                        @if (in_array($activity->activity_id, $activities_arr))
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_lname" name="booking_lname"
                      value="{{ $booking->booking_lname }}" placeholder="Enter Location" autocomplete="off">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_llink" name="booking_llink"
                      value="{{ $booking->booking_llink }}" placeholder="Enter Location Link" autocomplete="off">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_order_no" name="booking_order_no"
                      value="{{ $booking->booking_order_no }}" placeholder="Enter Order No" autocomplete="off">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_crequest_no" name="booking_crequest_no"
                      value="{{ $booking->booking_crequest_no }}" placeholder="Enter Client Request No"
                      autocomplete="off">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_cjob_no" name="booking_cjob_no"
                      value="{{ $booking->booking_cjob_no }}" placeholder="Enter Client Job No" autocomplete="off">
                ...
                @php
                  $files = json_decode($booking->booking_file, true);
                @endphp
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label class="form-label">File
                      @if (!empty($booking->booking_file))
                    ...
                    <select class="form-control selectbox" name="booking_branch">
                      ...
                      @foreach ($locations as $location)
                        <option value="{{ $location->location_id }}"
                          {{ $booking->booking_branch == $location->location_id ? "selected" : "" }}>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="booking_instruction" name="booking_instruction" placeholder="Enter Instruction"
                      autocomplete="off">{{ $booking->booking_instruction }}</textarea>
