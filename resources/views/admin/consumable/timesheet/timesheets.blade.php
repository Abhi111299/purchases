...
@section("contents")
  <section class="content">
    <div class="d-flex justify-content-between align-items-center pb-4">
      ...
      <div>
        <a href="{{ url("admin/timesheet_download_excel?staff_id=&from_date=&to_date=") }}" id="excel_download"
...
@section("custom_script")
  <script>
    ...
    function filter_options() {
      ...
      var excel_url = window.location.origin + '/admin/timesheet_download_excel?staff_id=' + staff_id + '&from_date=' +
