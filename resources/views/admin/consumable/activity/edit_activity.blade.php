...
@section("title", config("constants.site_title") . " | Edit Activity")
@section("contents")
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card panel-bd">
          <div class="card-body">
            <form id="activity_form" action="{{ url("admin/edit_activity/" . Request()->segment(3)) }}" method="post">
              @csrf
              <div class="row">
                ...
                <div class="col-md-12 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="activity_code" value="{{ $activity->activity_code }}"
