...
@section("title", config("constants.site_title") . " | Edit Staff")
@section("contents")
  <section class="content-header">
    <div class="header-title">
      <h4 class="text-white">Edit Staff</h4>
    </div>
  </section>
          ...
          <ul class="nav nav-underline" id="myTab">
            <li class="nav-item">
              ...
              <button class="nav-link active" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal"
                type="button" role="tab" aria-controls="personal" aria-selected="true">Personal information</button>
            ...
            <li class="nav-item">
              <button class="nav-link" id="safety-tab" data-bs-toggle="tab" data-bs-target="#safety" type="button"
                role="tab" aria-controls="safety" aria-selected="false">Safety Induction</button>
              {{-- <a class="nav-link" href="#tab3" data-toggle="tab">Safety Induction</a> --}}
            ...
            <li class="nav-item">
              ...
              {{-- <a class="nav-link" href="#tab4" data-toggle="tab">Safety Licence/Tickets</a> --}}
            </li>
            <li class="nav-item">
              <button class="nav-link" id="identification-tab" data-bs-toggle="tab" data-bs-target="#identification"
                type="button" role="tab" aria-controls="identification" aria-selected="false">Identification</button>
              {{-- <a class="nav-link" href="#tab5" data-toggle="tab">Identification</a> --}}
            </li>
            <li class="nav-item">
              ...
              {{-- <a class="nav-link" href="#tab6" data-toggle="tab">Documents</a> --}}
            </li>
          </ul>
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane active" id="personal" role="tabpanel" aria-labelledby="personal-tab" tabindex="0">
              <div class="card-body">
                <form id="staff_form" action="{{ url("admin/edit_staff/" . Request()->segment(3)) }}" method="post">
                  @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <label class="form-label">Employee No</label>
                        <input type="text" class="form-control" name="staff_no" value="{{ $staff->staff_no }}"
                        ...
                        <select class="form-control" name="staff_dept">
                          ...
                          @foreach ($departments as $department)
                            <option value="{{ $department->department_id }}"
                              {{ $staff->staff_dept == $department->department_id ? "selected" : "" }}>
                        ...
                        <select class="form-control" name="staff_role">
                          ...
                          @foreach ($roles as $role)
                            <option value="{{ $role->role_id }}"
                              {{ $staff->staff_role == $role->role_id ? "selected" : "" }}>{{ $role->role_name }}
                            </option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="staff_job_type">
                          <option value="">Select</option>
                          <option value="1" {{ $staff->staff_job_type == 1 ? "selected" : "" }}>Permanent</option>
                          <option value="2" {{ $staff->staff_job_type == 2 ? "selected" : "" }}>Temporary</option>
                          <option value="3" {{ $staff->staff_job_type == 3 ? "selected" : "" }}>Casual</option>
                          <option value="4" {{ $staff->staff_job_type == 4 ? "selected" : "" }}>ABN</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="staff_password"
                          value="{{ base64_decode($staff->staff_vpassword) }}" placeholder="Enter Password"
                          autocomplete="off">
                    ...
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="staff_nationality"
                          value="{{ $staff->staff_nationality }}" placeholder="Enter Nationality" autocomplete="off">
                    ...
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        ...
                        <select name="staff_employement" class="form-control selectbox">
                          <option value="">Select</option>
                          <option value="1" {{ $staff->staff_employement == 1 ? "selected" : "" }}>Current
                          </option>
                          <option value="2" {{ $staff->staff_employement == 2 ? "selected" : "" }}>Ex-Employee
                          </option>
                        </select>
                      </div>
                    </div>
            ...
            <div class="tab-pane fade" id="qualification">
              <div class="card-body">
                <form id="staff_qualification_form"
                  action="{{ url("admin/add_staff_qualification/" . Request()->segment(3)) }}" method="post"
                            ...
                            @if ($qualifications->count() > 0)
                              @foreach ($qualifications as $qualification)
                                <tr id="certificate_div_{{ $loop->iteration }}">
                                  ...
                                  <td>
                                    <input type="text" name="certification_details[CLEVEL][{{ $loop->iteration }}]"
            ...
            <div class="tab-pane fade" id="safety" role="tabpanel" aria-labelledby="safety-tab" tabindex="0">
              <div class="card-body">
                <form id="staff_induction_form"
                  action="{{ url("admin/add_staff_induction/" . Request()->segment(3)) }}" method="post"
                  enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-12">
                              ...
                              <tr id="induction_div_1">
                                ...
                                <td>
                                  <input type="text" name="induction_details[EDATE][1]"
                                    class="form-control iexpiry_date" value="" placeholder="Select Expiry Date">
                                </td>
                                <td>
            ...
            <div class="tab-pane fade" id="licence">
              <div class="card-body">
                <form id="staff_licence_form" action="{{ url("admin/add_staff_licence/" . Request()->segment(3)) }}"
                            ...
                            @if ($licences->count() > 0)
                              @foreach ($licences as $licence)
                                <tr id="licence_div_{{ $loop->iteration }}">
                                  ...
                                  <td>
                                    <input type="text" name="validation_details[LOCATION][{{ $loop->iteration }}]"
                                      class="form-control validation_location"
                                      value="{{ $licence->slicence_tlocation }}" placeholder="Enter Training Location"
                                      autocomplete="off">
                                  </td>
                                  <td>
                                    <input type="text"
                              ...
                              <tr id="licence_div_1">
                                ...
                                <td>
                                  <input type="text" name="validation_details[EDATE][1]"
                                    class="form-control vexpiry_date" value="" placeholder="Select Expiry Date">
                                </td>
                                <td>
            ...
            <div class="tab-pane fade" id="identification" role="tabpanel" aria-labelledby="identification-tab"
              tabindex="0">
              <div class="card-body">
                <form id="staff_identification_form"
                  action="{{ url("admin/add_staff_identification/" . Request()->segment(3)) }}" method="post"
                  enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
            ...
            <div class="tab-pane fade" id="document" role="tabpanel" aria-labelledby="document-tab" tabindex="0">
              <div class="card-body">
                <form id="staff_document_form" action="{{ url("admin/add_staff_document/" . Request()->segment(3)) }}"
                  method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-12">
                              ...
                              @foreach ($documents["NAME"] as $dkey => $document)
                                <tr id="document_div_{{ $loop->iteration }}">
                                  ...
                                  <td>
                                    ...
                                    @else
                                      <input type="hidden" name="documents[{{ $loop->iteration }}]" value="">
                                    @endif
                                  </td>
                                  <td>
                                    @if ($loop->iteration == 1)
