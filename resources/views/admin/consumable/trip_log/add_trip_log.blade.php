             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('admin/trip_logs/'.Request()->segment(3)) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
                    ...
                    @csrf
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                           <label>Driver</label>
                           <input type="text" class="form-control" name="trip_log_driver" value="{{ old('trip_log_driver') }}" placeholder="Enter Driver" autocomplete="off">
