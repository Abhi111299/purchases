             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('admin/trip_logs/'.$trip_log->trip_log_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="trip_log_form" action="{{ url('admin/edit_trip_log/'.Request()->segment(3)) }}" method="post">
                    @csrf
