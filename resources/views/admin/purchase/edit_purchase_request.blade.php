...
@section("contents")
  <section class="content-header">
    <div class="header-title">
      <h4 class="text-white mb-0">Edit Purchase Request</h4>
    </div>
  </section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card panel-bd">
          <div class="card-body">
            <form id="leave_form" action="{{ url("admin/edit_purchase_request/" . $purchase_request->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                  <input type="hidden" class="form-control" name="request_number" value="{{ $purchase_request->request_number }}">
                    <label class="form-label">Item Name</label>
                    <input type="text" class="form-control" name="item_name" value="{{ $purchase_request->item_name }}"
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="request_date" value="{{ date("d-m-Y", strtotime($purchase_request->request_date)) }}"
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="unit" value="{{ $purchase_request->unit }}"
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" value="{{ $purchase_request->price }}"
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Reason" autocomplete="off">{{ $purchase_request->item_description }}</textarea>
