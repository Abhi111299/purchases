...
@section("contents")
  <section class="content-header">
    <div class="d-flex justify-content-between align-items-center pb-4">
      ...
      <div>
        <a href="{{ url("admin/add_trip_log/" . Request()->segment(3)) }}" class="btn btn-white"><i class="fa fa-plus"></i>
          Add Trip Log</a>
              ...
              <div class="tab-pane active" id="tab1">
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="trip_log_table" class="table " style="width: 100%">
                      <thead>
                        <tr class="info">
                          <th>#</th>
                          <th>Date</th>
