...
<script src="{{ asset(config("constants.admin_path") . "plugins/lobipanel/lobipanel.min.js") }}" type="text/javascript">
</script>
<script src="{{ asset(config("constants.admin_path") . "plugins/pace/pace.min.js") }}" type="text/javascript"></script>
<script src="{{ asset(config("constants.admin_path") . "plugins/slimScroll/jquery.slimscroll.min.js") }}"
  type="text/javascript"></script>
<script src="{{ asset(config("constants.admin_path") . "plugins/fastclick/fastclick.min.js") }}" type="text/javascript">
</script>
<script src="{{ asset(config("constants.admin_path") . "dist/js/custom.js") }}" type="text/javascript"></script>
<script src="{{ asset(config("constants.admin_path") . "plugins/chartJs/Chart.min.js") }}" type="text/javascript">
</script>
<script src="{{ asset(config("constants.admin_path") . "plugins/counterup/waypoints.js") }}" type="text/javascript">
</script>
<script src="{{ asset(config("constants.admin_path") . "plugins/counterup/jquery.counterup.min.js") }}"
  type="text/javascript"></script>
<script src="{{ asset(config("constants.admin_path") . "plugins/monthly/monthly.js") }}" type="text/javascript">
</script>
{{-- <script src="{{ asset(config("constants.admin_path") . "plugins/datatables/dataTables.min.js") }}"
  type="text/javascript"></script> --}}
...
<script src="{{ asset(config("constants.admin_path") . "plugins/datatables/dataTables.buttons.min.js") }}"
  type="text/javascript"></script>
<script src="{{ asset(config("constants.admin_path") . "plugins/datatables/buttons.print.min.js") }}"
  type="text/javascript"></script>
...
<script src="{{ asset(config("constants.admin_path") . "plugins/fullcalendar/fullcalendar.min.js") }}"
  type="text/javascript"></script>
