             ...
             <div class="panel-heading">
               <div class="row">
                 ...
                 <div class="col-md-6 text-right">
                    <a href="{{ url('admin/insurances/'.$insurance->insurance_vehicle) }}" class="btn btn-sm btn-success">Back</a>
                 </div>
               </div>
             </div>
             <div class="panel-body">
                <form id="insurance_form" action="{{ url('admin/edit_insurance/'.Request()->segment(3)) }}" method="post">
                    @csrf
